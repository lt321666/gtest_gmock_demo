...
MACRO(LOAD_LIBSPDLOG os arch)
    ...
    SET(SPDLOG_INCLUDE_DIR ${PROJECT_SOURCE_DIR}/3rdparty/target/${${os}}_${${arch}}/include)
    SET(SPDLOG_LIBRARY_DIR ${PROJECT_SOURCE_DIR}/3rdparty/target/${${os}}_${${arch}}/lib)

    IF (CMAKE_SYSTEM_NAME MATCHES "Linux")
        SET(SPDLOG_LIBS spdlog pthread)
